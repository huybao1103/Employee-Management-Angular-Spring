...
import com.api.util.Auth.Policies.UserPolicies;
...
public class UserController {
    ...
    // Create a user
    @PolicySecurityService.HasAllClaims(claims = { UserPolicies.VIEW, UserPolicies.EDIT } )
    @PostMapping
    ...
    // Get all users
    @PolicySecurityService.HasAllClaims(claims = { UserPolicies.VIEW } )
    @GetMapping
    ...
    // Delete a user
    @PolicySecurityService.HasAllClaims(claims = { UserPolicies.VIEW, UserPolicies.EDIT, UserPolicies.REMOVE } )
    @DeleteMapping("/{id}")
