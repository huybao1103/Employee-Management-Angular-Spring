...
public final class DepartmentPolicies {
    private DepartmentPolicies() {}

    // Define permission codes
    public static final String VIEW = "2.v";
    public static final String EDIT = "2.e";
    public static final String REMOVE = "2.r";
    ...
    public static final List<Map<String, String>> ALL_DEPARTMENT_POLICIES_NAME = List.of(
            Map.of("View", VIEW),
            Map.of("Edit", EDIT),
