...
public final class UserPolicies {
    ...
    public static final String VIEW = "3.v";
    public static final String EDIT = "3.e";
    public static final String REMOVE = "3.r";
    ...
    public static final List<Map<String, String>> ALL_USER_POLICIES_NAME = List.of(
            Map.of("View", VIEW),
            Map.of("Edit", EDIT),
